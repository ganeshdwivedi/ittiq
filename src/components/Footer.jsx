    ...
    return (
        <div className='bg-black  px-[30px] overflow-hidden mt-[66px] xl:px-[158px]'>
            ...
            <div className=' text-white py-4 lg:py-[28px] flex flex-col lg:flex-row justify-between lg:items-center'>
                <p className="text-[16px] text-white font-[600]">Canada<br />
                    Chemin D’aigremont<br />
                    Lorraine Quebec<br />
                    Republic Of Benin - Lot 29<br />
                    PK Cotonou</p>
                <div className='flex flex-row items-center gap-x-[25px]'><PhoneSVG /> <p className="text-[16px] lg:py-0 py-4 text-white font-[600]">P+229-54335532</p></div>
                <div className='flex flex-row items-center gap-x-[25px]'><EmailSVG /> <p className="text-[16px] text-white font-[600]">info@email.com</p></div>
            ...
            <div className='text-white py-[28px] gap-x-10 flex flex-col lg:flex-row justify-between'>
                <div><p>loremipsum© 2023. All Rights Reserved.</p></div>
                <div className='grid grid-rows-1 gap-y-10 gap-x-0 lg:gap-x-10 lg:grid-cols-4'>
                    <p className="text-[14px] text-white hover:scale-110 font-[400]">Privacy Policy</p>
                    <p className="text-[14px] font-[400] text-white hover:scale-105">Terms & Condition </p>
                    <p className="text-[14px] font-[400] text-white hover:scale-105">Site Map</p>
                </div>
